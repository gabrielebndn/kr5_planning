function jac=computeFullJacobian(q)
  ...
  jac(4,3)=s1;
  jac(4,4)=c1*s23;
  jac(4,5)=s1*c4-c23*c1*s4;
  jac(4,6)=s5*(s1*s4+c23*c1*c4)+s23*c1*c5;

  jac(5,1)=0;
  jac(5,2)=-c1;
  jac(5,3)=-c1;
  jac(5,4)=s1*s23;
  jac(5,5)=-c1*c4-c23*s1*s4;
  jac(5,6)=-s5*(c1*s4-c23*s1*c4)+s23*s1*c5;
