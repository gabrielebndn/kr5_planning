%computes desired config with inv_kin & inputs it (directly, w/o vel; & no scaling)
...
q(:,2:delay)=repmat(q(:,1),1,delay-1);
...
for k=1:N
    ...
    q_des=inv_kin6s(Tk_des);
    cmdVel=scale((q_des-q_e)/dt,v_max);
    q_cmd=q_e+cmdVel*dt;
